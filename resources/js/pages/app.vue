<script setup>
import NavbarCenterLight from "./layouts/navbar-center-light.vue";

import ComImage from '../../images/hosting/com.jpg';
import bizImage from '../../images/hosting/biz.jpg';
import meImage from '../../images/hosting/me.jpg';
import mobiImage from '../../images/hosting/mobi.jpg';
import netImage from '../../images/hosting/net.jpg';
import orgImage from '../../images/hosting/org.jpg';
import tvImage from '../../images/hosting/tv.jpg';
import usImage from '../../images/hosting/us.jpg';
import TwoImage from '../../images/hosting/2.png';
import OneImage from '../../images/hosting/1.png';

</script>

<template>
    <navbar-center-light></navbar-center-light>

    <!-- Start Hero -->
    <section class="relative table w-full py-36 lg:py-52 bg-[url('../images/hosting/bg-hosting.jpg')] bg-center bg-no-repeat bg-cover">
    ...
    <section class="relative md:py-24 py-16 pt-5">
                    ...
                    <div class="grid grid-cols-1 mt-8">
                        <div class="tiny-six-item">
                            <div class="tiny-slide">
                                <a href="" class="group bg-white dark:bg-slate-900 block rounded-md overflow-hidden relative shadow dark:shadow-gray-800 m-2">
                                        <span class="p-4 block bg-white dark:bg-slate-900 text-center">
                                            <img :src="ComImage" class="rounded-full shadow-md mx-auto h-16 w-16 mb-3" alt="">

                                            <span class="text-xl font-medium group-hover:text-indigo-600 duration-500">.com</span>
                            ...
                            <div class="tiny-slide">
                                <a href="" class="group bg-white dark:bg-slate-900 block rounded-md overflow-hidden relative shadow dark:shadow-gray-800 m-2">
                                        <span class="p-4 block bg-white dark:bg-slate-900 text-center">
                                            <img :src="bizImage" class="rounded-full shadow-md mx-auto h-16 w-16 mb-3" alt="">

                                            <span class="text-xl font-medium group-hover:text-emerald-600 duration-500">.biz</span>
                                            <span class="text-slate-400 block">best price in the industry</span>
                                        </span>
                            ...
                            <div class="tiny-slide">
                                <a href="" class="group bg-white dark:bg-slate-900 block rounded-md overflow-hidden relative shadow dark:shadow-gray-800 m-2">
                                        <span class="p-4 block bg-white dark:bg-slate-900 text-center">
                                            <img :src="meImage" class="rounded-full shadow-md mx-auto h-16 w-16 mb-3" alt="">

                                            <span class="text-xl font-medium group-hover:text-red-600 duration-500">.me</span>
                                            <span class="text-slate-400 block">best price in the industry</span>
                                        </span>
                            ...
                            <div class="tiny-slide">
                                <a href="" class="group bg-white dark:bg-slate-900 block rounded-md overflow-hidden relative shadow dark:shadow-gray-800 m-2">
                                        <span class="p-4 block bg-white dark:bg-slate-900 text-center">
                                            <img :src="mobiImage" class="rounded-full shadow-md mx-auto h-16 w-16 mb-3" alt="">

                                            <span class="text-xl font-medium group-hover:text-sky-600 duration-500">.mobi</span>
                                            <span class="text-slate-400 block">best price in the industry</span>
                                        </span>
                            ...
                            <div class="tiny-slide">
                                <a href="" class="group bg-white dark:bg-slate-900 block rounded-md overflow-hidden relative shadow dark:shadow-gray-800 m-2">
                                        <span class="p-4 block bg-white dark:bg-slate-900 text-center">
                                            <img :src="netImage" class="rounded-full shadow-md mx-auto h-16 w-16 mb-3" alt="">

                                            <span class="text-xl font-medium group-hover:text-amber-500 duration-500">.net</span>
                                            <span class="text-slate-400 block">best price in the industry</span>
                                        </span>
                            ...
                            <div class="tiny-slide">
                                <a href="" class="group bg-white dark:bg-slate-900 block rounded-md overflow-hidden relative shadow dark:shadow-gray-800 m-2">
                                        <span class="p-4 block bg-white dark:bg-slate-900 text-center">
                                            <img :src="orgImage" class="rounded-full shadow-md mx-auto h-16 w-16 mb-3" alt="">

                                            <span class="text-xl font-medium group-hover:text-emerald-600 duration-500">.org</span>
                                            <span class="text-slate-400 block">best price in the industry</span>
                                        </span>
                            ...
                            <div class="tiny-slide">
                                <a href="" class="group bg-white dark:bg-slate-900 block rounded-md overflow-hidden relative shadow dark:shadow-gray-800 m-2">
                                        <span class="p-4 block bg-white dark:bg-slate-900 text-center">
                                            <img :src="tvImage" class="rounded-full shadow-md mx-auto h-16 w-16 mb-3" alt="">

                                            <span class="text-xl font-medium group-hover:text-red-600 duration-500">.tv</span>
                                            <span class="text-slate-400 block">best price in the industry</span>
                                        </span>
                            ...
                            <div class="tiny-slide">
                                <a href="" class="group bg-white dark:bg-slate-900 block rounded-md overflow-hidden relative shadow dark:shadow-gray-800 m-2">
                                        <span class="p-4 block bg-white dark:bg-slate-900 text-center">
                                            <img :src="usImage" class="rounded-full shadow-md mx-auto h-16 w-16 mb-3" alt="">

                                            <span class="text-xl font-medium group-hover:text-sky-600 duration-500">.us</span>
                                            <span class="text-slate-400 block">best price in the industry</span>
                                        </span>
        ...
        <div class="container relative md:mt-24 mt-16">
            ...
            <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                <div class="group relative p-6 shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 hover:bg-indigo-600 dark:hover:bg-indigo-600 duration-500 rounded-xl bg-white dark:bg-slate-900 overflow-hidden">
                    ...
                    <div class="mt-6">
                        <a href="" class="text-lg font-medium group-hover:text-white duration-500">Web Hosting</a>
                        <p class="text-slate-400 group-hover:text-white/50 duration-500 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    </div>
                </div><!--end feature-->
                ...
                <div class="group relative p-6 shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 hover:bg-indigo-600 dark:hover:bg-indigo-600 duration-500 rounded-xl bg-white dark:bg-slate-900 overflow-hidden">
                    ...
                    <div class="mt-6">
                        <a href="" class="text-lg font-medium group-hover:text-white duration-500">Domains</a>
                        <p class="text-slate-400 group-hover:text-white/50 duration-500 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    </div>
                </div><!--end feature-->
                ...
                <div class="group relative p-6 shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 hover:bg-indigo-600 dark:hover:bg-indigo-600 duration-500 rounded-xl bg-white dark:bg-slate-900 overflow-hidden">
                    ...
                    <div class="mt-6">
                        <a href="" class="text-lg font-medium group-hover:text-white duration-500">Emails</a>
                        <p class="text-slate-400 group-hover:text-white/50 duration-500 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    </div>
                </div><!--end feature-->
                ...
                <div class="group relative p-6 shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 hover:bg-indigo-600 dark:hover:bg-indigo-600 duration-500 rounded-xl bg-white dark:bg-slate-900 overflow-hidden">
                    ...
                    <div class="mt-6">
                        <a href="" class="text-lg font-medium group-hover:text-white duration-500">Supported</a>
                        <p class="text-slate-400 group-hover:text-white/50 duration-500 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    </div>
                </div><!--end feature-->
                ...
                <div class="group relative p-6 shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 hover:bg-indigo-600 dark:hover:bg-indigo-600 duration-500 rounded-xl bg-white dark:bg-slate-900 overflow-hidden">
                    ...
                    <div class="mt-6">
                        <a href="" class="text-lg font-medium group-hover:text-white duration-500">Speedy</a>
                        <p class="text-slate-400 group-hover:text-white/50 duration-500 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    </div>
                </div><!--end feature-->
                ...
                <div class="group relative p-6 shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 hover:bg-indigo-600 dark:hover:bg-indigo-600 duration-500 rounded-xl bg-white dark:bg-slate-900 overflow-hidden">
                    ...
                    <div class="mt-6">
                        <a href="" class="text-lg font-medium group-hover:text-white duration-500">Reliable</a>
                        <p class="text-slate-400 group-hover:text-white/50 duration-500 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    </div>
                </div><!--end feature-->
                ...
                <div class="group relative p-6 shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 hover:bg-indigo-600 dark:hover:bg-indigo-600 duration-500 rounded-xl bg-white dark:bg-slate-900 overflow-hidden">
                    ...
                    <div class="mt-6">
                        <a href="" class="text-lg font-medium group-hover:text-white duration-500">Scalable</a>
                        <p class="text-slate-400 group-hover:text-white/50 duration-500 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    </div>
                </div><!--end feature-->
                ...
                <div class="group relative p-6 shadow dark:shadow-gray-800 hover:shadow-md dark:hover:shadow-gray-700 hover:bg-indigo-600 dark:hover:bg-indigo-600 duration-500 rounded-xl bg-white dark:bg-slate-900 overflow-hidden">
                    ...
                    <div class="mt-6">
                        <a href="" class="text-lg font-medium group-hover:text-white duration-500">Easy Upgrade</a>
                        <p class="text-slate-400 group-hover:text-white/50 duration-500 mt-3">The phrasal sequence of the is now so that many campaign and benefit</p>
                    </div>
                </div><!--end feature-->
            </div>
                    ...
                    <div class="grid grid-cols-1 gap-[30px]">
                        <div class="group flex items-center relative overflow-hidden p-6 rounded-md shadow dark:shadow-gray-800 bg-gray-50 dark:bg-slate-800 hover:bg-indigo-600 dark:hover:bg-indigo-600 duration-500">
                            ...
                            <div class="flex-1 ms-3">
                                <h5 class="group-hover:text-white text-xl font-semibold duration-500">Enhance Security</h5>
                        ...
                        <div class="group flex items-center relative overflow-hidden p-6 rounded-md shadow dark:shadow-gray-800 bg-gray-50 dark:bg-slate-800 hover:bg-indigo-600 dark:hover:bg-indigo-600 duration-500">
                            ...
                            <div class="flex-1 ms-3">
                                <h5 class="group-hover:text-white text-xl font-semibold duration-500">High Performance</h5>
                                <p class="text-slate-400 group-hover:text-white/50 duration-500 mt-2">There are many variations of passages of Lorem Ipsum available</p>
                            </div>
                            <div class="absolute start-1 top-5 text-dark/[0.03] dark:text-white/[0.03] text-8xl group-hover:text-white/[0.04] duration-500">
                                <i class="uil uil-tachometer-fast-alt"></i>
                        ...
                        <div class="group flex items-center relative overflow-hidden p-6 rounded-md shadow dark:shadow-gray-800 bg-gray-50 dark:bg-slate-800 hover:bg-indigo-600 dark:hover:bg-indigo-600 duration-500">
                            ...
                            <div class="flex-1 ms-3">
                                <h5 class="group-hover:text-white text-xl font-semibold duration-500">Unbeatable Support</h5>
                                <p class="text-slate-400 group-hover:text-white/50 duration-500 mt-2">There are many variations of passages of Lorem Ipsum available</p>
                            </div>
                            <div class="absolute start-1 top-5 text-dark/[0.03] dark:text-white/[0.03] text-8xl group-hover:text-white/[0.04] duration-500">
                                <i class="uil uil-user-check"></i>
                    ...
                    <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]">
                        <div class="group relative rounded-md overflow-hidden hover:shadow dark:hover:shadow-gray-700 bg-white dark:bg-slate-900 text-center duration-500 h-fit">
                            ...
                            <div class="p-6 hosting-price">
                                <ul class="inline-block flex-wrap justify-center text-center p-1 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-full" id="myTabone" data-tabs-toggle="#StarterContent" role="tablist">
                                    ...
                                    <li role="presentation" class="inline-block">
                                        <button class="px-4 py-1 text-sm font-semibold rounded-full w-full duration-500" id="start-year-tab" data-tabs-target="#start-year" type="button" role="tab" aria-controls="start-year" aria-selected="false">Yearly</button>
                                    </li>
                                </ul>
                            ...
                            <div class="p-4">
                                <a href="page-services.html" class="relative inline-block font-semibold tracking-wide align-middle text-base text-center border-none after:content-[''] after:absolute after:h-px after:w-0 hover:after:w-full after:end-0 hover:after:end-auto after:bottom-0 after:start-0 after:duration-500 text-indigo-600 hover:text-indigo-600 after:bg-indigo-600 duration-500 ease-in-out">Read More <i class="uil uil-angle-right-b align-middle"></i></a>
                            </div>
                        </div>
                        <!-- End Price Table -->
                        ...
                        <div class="group relative rounded-md overflow-hidden hover:shadow dark:shadow-gray-800 hover:shadow-indigo-600 border-[3px] border-indigo-600 bg-white dark:bg-slate-900 text-center duration-500">
                            ...
                            <div class="p-6 hosting-price">
                                <ul class="inline-block flex-wrap justify-center text-center p-1 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-full" id="myTabtwo" data-tabs-toggle="#PremiumContent" role="tablist">
                                    <li role="presentation" class="inline-block">
                                        <button class="px-4 py-1 text-sm font-semibold rounded-full w-full text-slate-400 hover:text-indigo-600 duration-500" id="pre-month-tab" data-tabs-target="#pre-month" type="button" role="tab" aria-controls="pre-month" aria-selected="true">Monthly</button>
                                    </li>
                                    <li role="presentation" class="inline-block">
                                        <button class="px-4 py-1 text-sm font-semibold rounded-full w-full text-slate-400 duration-500" id="pre-year-tab" data-tabs-target="#pre-year" type="button" role="tab" aria-controls="pre-year" aria-selected="false">Yearly</button>
                                    </li>
                                </ul>

                                <div id="PremiumContent" class="mt-6">
                                    <div class="" id="pre-month" role="tabpanel" aria-labelledby="pre-month-tab">
                                        <div class="flex justify-center">
                                            <span class="text-sm text-slate-400 font-semibold">$</span>
                                    ...
                                    <div class="hidden " id="pre-year" role="tabpanel" aria-labelledby="pre-year-tab">
                                        <div class="flex justify-center">
                                            <span class="text-sm text-slate-400 font-semibold">$</span>
                        ...
                        <div class="group relative rounded-md overflow-hidden hover:shadow dark:hover:shadow-gray-700 bg-white dark:bg-slate-900 text-center duration-500 h-fit">
                            ...
                            <div class="p-6 hosting-price">
                                <ul class="inline-block flex-wrap justify-center text-center p-1 bg-white dark:bg-slate-900 shadow dark:shadow-gray-800 rounded-full" id="myTabthree" data-tabs-toggle="#BusinessContent" role="tablist">
                                    <li role="presentation" class="inline-block">
                                        <button class="px-4 py-1 text-sm font-semibold rounded-full w-full text-slate-400 hover:text-indigo-600 duration-500" id="busi-month-tab" data-tabs-target="#busi-month" type="button" role="tab" aria-controls="busi-month" aria-selected="true">Monthly</button>
                                    </li>
                                    <li role="presentation" class="inline-block">
                                        <button class="px-4 py-1 text-sm font-semibold rounded-full w-full text-slate-400 duration-500" id="busi-year-tab" data-tabs-target="#busi-year" type="button" role="tab" aria-controls="busi-year" aria-selected="false">Yearly</button>
                                    </li>
                                </ul>

                                <div id="BusinessContent" class="mt-6">
                                    <div class="" id="busi-month" role="tabpanel" aria-labelledby="busi-month-tab">
                                        <div class="flex justify-center">
                                            <span class="text-sm text-slate-400 font-semibold">$</span>
                                    ...
                                    <div class="hidden " id="busi-year" role="tabpanel" aria-labelledby="busi-year-tab">
                                        <div class="flex justify-center">
                                            <span class="text-sm text-slate-400 font-semibold">$</span>
    ...
    <section class="relative md:py-24 py-16 bg-[url('../../assets/images/hosting/bg.png')] bg-bottom bg-no-repeat bg-cover">
        <div class="container relative">
            <div class="grid grid-cols-1 pb-8 text-center">
            ...
            <div class="md:flex justify-center">
                <div class="lg:w-2/3 md:w-full">
                    <div id="accordion-collapse" data-accordion="collapse" class="mt-6">
                        ...
                        <div class="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden mt-4">
                            <h2 class="text-base font-semibold bg-white dark:bg-slate-900" id="accordion-collapse-heading-6">
                            ...
                            <div id="accordion-collapse-body-6" class="hidden bg-white dark:bg-slate-900" aria-labelledby="accordion-collapse-heading-6">
                                <div class="p-5">
                                    <p class="text-slate-400 dark:text-gray-400">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                                </div>
                            </div>
                        ...
                        <div class="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden mt-4">
                            <h2 class="text-base font-semibold bg-white dark:bg-slate-900" id="accordion-collapse-heading-7">
                            ...
                            <div id="accordion-collapse-body-7" class="hidden bg-white dark:bg-slate-900" aria-labelledby="accordion-collapse-heading-7">
                                <div class="p-5">
                                    <p class="text-slate-400 dark:text-gray-400">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                                </div>
                            </div>
                        ...
                        <div class="relative shadow dark:shadow-gray-800 rounded-md overflow-hidden mt-4">
                            <h2 class="text-base font-semibold bg-white dark:bg-slate-900" id="accordion-collapse-heading-8">
                            ...
                            <div id="accordion-collapse-body-8" class="hidden bg-white dark:bg-slate-900" aria-labelledby="accordion-collapse-heading-8">
                                <div class="p-5">
                                    <p class="text-slate-400 dark:text-gray-400">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form.</p>
                                </div>
                            </div>
